...
export default function GalleryImages({ extraClassNames }) {
    ...
    return (
        <>
            <div className={`w-100 d-none d-lg-flex justify-content-between ${extraClassNames}`}>
            ...
            <div className={`w-100 d-none d-md-flex d-lg-none justify-content-between ${extraClassNames}`}>
                <div style={{width: '9.5%', margin: '0 .25%', height: '110%', borderRadius: '16px', border: '4px solid var(--pureWhite)', borderTopLeftRadius: '0', borderBottomLeftRadius: '0', borderLeft: '0'}}>
                    <img src={`/images/${MdImages[0]}`} className="galleryImage" style={{borderTopLeftRadius: '0', borderBottomLeftRadius: '0'}} />
                </div>
                <div style={{width: '24.5%', margin: '0 .25%', height: '120%', borderRadius: '16px', border: '4px solid var(--pureWhite)'}}>
                ...
                <div style={{width: '9.5%', margin: '0 .25%', height: '110%', borderRadius: '16px', border: '4px solid var(--pureWhite)', borderTopRightRadius: '0', borderBottomRightRadius: '0', borderRight: '0'}}>
            ...
            <div className={`w-100 d-none d-sm-flex d-md-none justify-content-between ${extraClassNames}`}>
                <div style={{width: '28%', margin: '0 1%', height: '140%', borderRadius: '16px', border: '4px solid var(--pureWhite)', borderTopLeftRadius: '0', borderBottomLeftRadius: '0', borderLeft: '0'}}>
                ...
                <div style={{width: '28%', margin: '0 1%', height: '140%', borderRadius: '16px', border: '4px solid var(--pureWhite)', borderTopRightRadius: '0', borderBottomRightRadius: '0', borderRight: '0'}}>
            ...
            <div className={`w-100 d-flex d-sm-none justify-content-between ${extraClassNames}`}>
                <div style={{width: '13%', margin: '0 1%', height: '100%', borderRadius: '16px', border: '4px solid var(--pureWhite)', borderTopLeftRadius: '0', borderBottomLeftRadius: '0', borderLeft: '0'}}>
                    <img src={`/images/${SmImages[0]}`} className="galleryImage" style={{borderTopLeftRadius: '0', borderBottomLeftRadius: '0'}} />
                </div>
                <div style={{width: '68%', margin: '0 1%', height: '110%', borderRadius: '16px', border: '4px solid var(--pureWhite)'}}>
                    <img src={`/images/${SmImages[1]}`} className="galleryImage" />
                </div>
                <div style={{width: '13%', margin: '0 1%', height: '100%', borderRadius: '16px', border: '4px solid var(--pureWhite)', borderTopRightRadius: '0', borderBottomRightRadius: '0', borderRight: '0'}}>
                    <img src={`/images/${SmImages[2]}`} className="galleryImage" style={{borderTopRightRadius: '0', borderBottomRightRadius: '0'}} />
                </div>
